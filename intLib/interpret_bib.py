...
# Test all cases: python3 bin/test.py -o golden.log -- python3 solutions/interpret.py
# Test cases but filter by methods: python3 bin/test.py --filter-methods=divideByN\: -o golden.log -- python3 solutions/interpret.py
# Test one method: python3 solutions/interpret.py 'jpamb.cases.Simple.divideByN:(I)I' '(2)'
